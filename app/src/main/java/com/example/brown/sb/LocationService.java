...
public class LocationService extends Service implements LocationListener {
    ...
    public void onCreate() {
        final String un = getSharedPreferences("logInfo", MODE_PRIVATE).getString("username","");

        MessageToast.message(this,"call");
        ...
        String lng = Double.toString(lon);
        String subject = "";

        String method = "location";

        MessageToast.message(this,lati);

        BackgroundLocationTask backgroundLocationTask = new BackgroundLocationTask();
        backgroundLocationTask.execute(method,lati,lng,un);
                ...
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 30000, 10, LocationService.this);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        backgroundTask.execute(method,lati, lng);
    }
